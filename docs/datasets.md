...
- `edges2shoes-r`: Redistributed version of `edges2shoes` dataset. The new dataset contains 2048 images in the validation set.
- `edges2handbags`: 137K Amazon Handbag images from [iGAN project](https://github.com/junyanz/iGAN). Edges are computed by [HED](https://github.com/s9xie/hed) edge detector + post-processing. [[Citation](datasets/bibtex/handbags.tex)]
- `edges2handbags-r`: Redistributed version of `edges2handbags` dataset. The new dataset contains 2048 images in the validation set.
