...
Below we show the full pipeline for compressing pix2pix model. **We provide pre-trained models after some steps. You could use the pretrained models to skip some steps.** 
